...
K is runtime-derived from action_labels.json (typically 8 on denseworld after the
...
def load_motion_targets_for_training(motion_features_path: Path,
    ...
    Returns (lookup, n_motion_classes, vec_mean, vec_std):
      ...
      n_motion_classes: int — derived from max(class_id) + 1 (typically 8 on denseworld)
