...
ds = load_dataset("anon-org/denseworld-115k", streaming=True)
...
```
@dataset{{denseworld200k,
  title={{DenseWorld-200K: Indian Street Video Clips for Video Foundation Model Evaluation}},
  author={{Anonymous}},
  year={{2026}},
  url={{https://huggingface.co/datasets/anon-org/denseworld-115k}}
}}
```
