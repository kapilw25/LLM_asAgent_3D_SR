...
While DPO and its variants align model behavior through pairwise preference loss, they overlook the internal mechanisms that lead to unsafe completions. GRACE complements preference learning by supervising these mechanisms directly in the embedding space. Our contrastive losses target adversarial proximity and unsafe dispersion—factors often missed by output-only training. This hybrid formulation leads to sharper representation boundaries and generalizes better to unseen attacks.
