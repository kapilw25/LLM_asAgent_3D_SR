...
WalkIndia walking (radial flow), which killed the arrow/direction demos. The hypothesis this
...
def main():
    ...
    ap.add_argument("--stride", type=int, default=6,
                    help="decode every Nth frame; 6 == 5 fps pairs on 30 fps WalkIndia clips")
