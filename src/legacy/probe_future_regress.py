...
USAGE:
    python -u src/legacy/probe_future_regress.py --SANITY \\
    ...
    python -u src/legacy/probe_future_regress.py --FULL \\
    ...
    python -u src/legacy/probe_future_regress.py --FULL --stage paired_per_variant \\
